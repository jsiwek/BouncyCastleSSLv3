...
{
    public static final int SSL_NULL_WITH_NULL_NULL = 0x0000;
    public static final int SSL_RSA_WITH_NULL_MD5 = 0x0001;
    public static final int SSL_RSA_WITH_NULL_SHA = 0x0002;
    public static final int SSL_RSA_EXPORT_WITH_RC4_40_MD5 = 0x0003;
    public static final int SSL_RSA_WITH_RC4_128_MD5 = 0x0004;
    public static final int SSL_RSA_WITH_RC4_128_SHA = 0x0005;
    public static final int SSL_RSA_EXPORT_WITH_RC2_CBC_40_MD5 = 0x0006;
    public static final int SSL_RSA_WITH_IDEA_CBC_SHA = 0x0007;
    public static final int SSL_RSA_EXPORT_WITH_DES40_CBC_SHA = 0x0008;
    public static final int SSL_RSA_WITH_DES_CBC_SHA = 0x0009;
    public static final int SSL_RSA_WITH_3DES_EDE_CBC_SHA = 0x000A;
    public static final int SSL_DH_DSS_EXPORT_WITH_DES40_CBC_SHA = 0x000B;
    public static final int SSL_DH_DSS_WITH_DES_CBC_SHA = 0x000C;
    public static final int SSL_DH_DSS_WITH_3DES_EDE_CBC_SHA = 0x000D;
    public static final int SSL_DH_RSA_EXPORT_WITH_DES40_CBC_SHA = 0x000E;
    public static final int SSL_DH_RSA_WITH_DES_CBC_SHA = 0x000F;
    public static final int SSL_DH_RSA_WITH_3DES_EDE_CBC_SHA = 0x0010;
    public static final int SSL_DHE_DSS_EXPORT_WITH_DES40_CBC_SHA = 0x0011;
    public static final int SSL_DHE_DSS_WITH_DES_CBC_SHA = 0x0012;
    public static final int SSL_DHE_DSS_WITH_3DES_EDE_CBC_SHA = 0x0013;
    public static final int SSL_DHE_RSA_EXPORT_WITH_DES40_CBC_SHA = 0x0014;
    public static final int SSL_DHE_RSA_WITH_DES_CBC_SHA = 0x0015;
    public static final int SSL_DHE_RSA_WITH_3DES_EDE_CBC_SHA = 0x0016;
    public static final int SSL_DH_anon_EXPORT_WITH_RC4_40_MD5 = 0x0017;
    public static final int SSL_DH_anon_WITH_RC4_128_MD5 = 0x0018;
    public static final int SSL_DH_anon_EXPORT_WITH_DES40_CBC_SHA = 0x0019;
    public static final int SSL_DH_anon_WITH_DES_CBC_SHA = 0x001A;
    public static final int SSL_DH_anon_WITH_3DES_EDE_CBC_SHA = 0x001B;
    /**
     * FORTEZZA unimplemented
     */
